  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashborad"
        subtitle="monitor your room listings, track bookings and analyze revenuw-all in one place. stay updated with real-time insights to ensure smooth operations."
      />
      <div className="flex gap-4 my-8">
        ...
        <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
          <img
            ...
            alt="totalRevenueIconIcon"
            className="max-sm:hidden h-10"
          />
          <div className="flex flex-col sm:ml-4 font-medium">
            <p className="text-blue-500 text-lg">Total Revenue</p>
            <p className="text-neutral-400 text-base">
              $ {dashboradData.totalRevenue}
            </p>
          </div>
        </div>
      </div>
